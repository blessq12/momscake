                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="banner-item-content">
                            <span>Домашнаяя кондитерская</span>
                            <h1>Выбирай только натуральное!</h1>
                ...
                <div class="row pt-45">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="offer-item">
                            ...
                            <div class="content">
                                <h3><a href="shop-details.html">Natural Fresh Orange</a></h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="offer-item">
                            ...
                            <div class="content">
                                <h3><a href="shop-details.html">Organic Cucumber</a></h3>
                ...
                <div class="row pt-45">
                    <div class="col-lg-3 col-sm-6">
                        <div class="new-arrival-item">
                            ...
                            <div class="content">
                                <h3><a href="shop-details.html">Organic Fresh Capsicum</a></h3>
                    ...
                    <div class="col-lg-3 col-sm-6 col-sm-6">
                        <div class="new-arrival-item">
                            ...
                            <div class="content">
                                <h3><a href="shop-details.html">Super Natural Brinjal</a></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="trending-item">
                                    ...
                                    <div class="content">
                                        <h3><a href="shop-details.html">Super Natural Milk</a></h3>
                                        <div class="rating">
                                            <i class='bx bxs-star'></i>
                                            <i class='bx bxs-star'></i>
                                            <i class='bx bxs-star'></i>
